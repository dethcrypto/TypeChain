...
import type { DataTypesInputInstance } from '../types/truffle-contracts/DataTypesInput'
...
contract('DataTypesInput', ([deployer]) => {
  ...
  it('works', async () => {
    ...
    typedAssert(await c.input_bytes(web3.utils.fromAscii('TypeChain')), '0x54797065436861696e')
