...
export class SafeMath__factory extends ContractFactory {
  ...
  override connect(runner: ContractRunner | null): SafeMath__factory {
    return super.connect(runner) as SafeMath__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): SafeMathInterface {
    return new Interface(_abi) as SafeMathInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): SafeMath {
    return new Contract(address, _abi, runner) as unknown as SafeMath;
  }
}
